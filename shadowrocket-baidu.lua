...
function wa_lua_on_handshake_cb(ctx)
    ...
    if flags[uuid] ~= kHttpHeaderSent then
        ...
        local res = 'CONNECT ' .. host .. ':' .. port .. ' HTTP/1.1\r\n' ..
                    'Host: ' .. host .. ':' .. port .. '\r\n' ..
                    'User-Agent: Mozilla/5.0 (iPhone; CPU iPhone OS 15_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 SP-engine/2.46.0 main%2F1.0 baiduboxapp/13.8.0.12 (Baidu; P2 15.5) NABar/1.0 themeUA=Theme/default webCore=0x1157d3540\r\n'..
